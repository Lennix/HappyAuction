...
namespace HappyAuction
{
    ...
    protected:
        ...
        ULong _haItem()
        {
            ...
            // Happy Auction Advanced
            _SetTable("max_bid", _state.item.max_bid);
            _SetTable("current_bid", _state.item.current_bid);
            _SetTable("ilvl", _state.item.ilevel);
            _SetTable("timeleft", _state.item.timeleft);
            _SetTable("flags", _state.item.flags);
